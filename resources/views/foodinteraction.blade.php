...
<body class="bg-white dark:bg-gray-800">
  ...
  <div id="mega-menu-full-dropdown" class="mt-1 border-gray-200 shadow-sm bg-gray-50 md:bg-white border-y dark:bg-gray-800 dark:border-gray-600 hidden" >
    ...
    <h1 class="text-5xl text-center py-8 text-white">التعارض مع الاطعمه</h1>
...
<hr class="w-48 h-1 mx-auto my-4 bg-gray-100 border-0 rounded md:my-10 dark:bg-gray-700">
        ...
        <form method="POST" action="{{ route('search') }}" class="w-2/4 mx-auto pb-16" onsubmit="return validateForm()">
    @csrf
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                       ...
                       <tr>
                          ...
                          <td class="px-6 py-4">{{ $result->food->name }}</td>
      ...
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        ...
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li class="mb-4">
                    <a href="illnessinteraction" class="hover:underline">التعارض مع الأمراض المزمنه</a>
                </li>
                <li class="mb-4">
