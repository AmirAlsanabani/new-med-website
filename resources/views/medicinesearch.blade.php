    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
      ...
      <li>
        <div class="flex items-center">
          ...
          <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">نتائج البحث</a>
        </div>
      </li>
...
<div style="margin-top: 100px; margin-bottom: 100px;">
  <h1 class="text-5xl font-extrabold dark:text-white" style="text-align: center; margin-bottom: 50px;">
    لا يوجد نتائج.
    <small class="ms-2 font-semibold text-gray-500 dark:text-gray-400">يرجى البحث مرة أخرى مع التدقيق</small>
  </h1>
</div>
@else
...
<div class="py-3 flex items-center text-sm text-gray-800 before:flex-[1_1_0%] before:border-t before:border-gray-200 before:me-6 after:flex-[1_1_0%] after:border-t after:border-gray-200 after:ms-6 dark:text-white dark:before:border-gray-600 dark:after:border-gray-600">نتائج البحث</div>
...
<ul>
  ...
  <li>
    <div id="alert-additional-content-5" class="p-4 border border-gray-300 rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-800" role="alert">
      ...
      <div class="flex">
        <a href="{{ route('medicine.show', $result->id) }}" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-xs px-3 py-1.5 me-2 text-center inline-flex items-center dark:bg-gray-600 dark:hover:bg-gray-500 dark:focus:ring-gray-800">
